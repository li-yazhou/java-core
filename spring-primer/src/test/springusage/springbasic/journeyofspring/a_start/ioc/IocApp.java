package springbasic.journeyofspring.a_start.ioc;
...
public class IocApp {
    ...
    public static void main(String[] args){
        // 如果 jdbc-beans.xml 位于类路径下，即在src下，则 String path = "jdbc-beans.xml";
        String path = "springbasic/journeyofspring/a_start/ioc/beans.xml";
