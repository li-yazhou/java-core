package javabase.javase.collection;
...
public class CollectionDemo {
    ...
    private LinkedList<String> noSafeStack = new LinkedList<>();
    ...
    public void testCollection() {
        ...
        Collection emptySet = Collections.EMPTY_SET;
        ...
        Collections.checkedCollection(emptyList, String.class);
