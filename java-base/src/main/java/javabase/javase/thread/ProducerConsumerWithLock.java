package javabase.javase.thread;
...
public class ProducerConsumerWithLock {
    ...
    public static void main(String[] args)
    {
        ...
        ProducerWithLock pro = new ProducerWithLock(r);
        ConsumerWithLock con = new ConsumerWithLock(r);
...
{
    private ResourceWithLock r;
    ProducerWithLock(ResourceWithLock r)
    {
        this.r = r;
    }
    public void run()
...
{
    private ResourceWithLock r;
    ConsumerWithLock(ResourceWithLock r)
    {
        this.r = r;
    }
    public void run()
