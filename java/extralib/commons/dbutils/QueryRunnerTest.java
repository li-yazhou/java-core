package extralib.commons.dbutils;
...
public class QueryRunnerTest {
    ...
    public void queryByBeanHandler() throws SQLException {
        ...
        Student student = queryRunner.query(conn, sql, new BeanHandler<>(Student.class), 10);
    ...
    public void queryByBeanListHandler() throws SQLException{
        ...
        List<Student> studentList = queryRunner.query(conn, sql, new BeanListHandler<>(Student.class));
