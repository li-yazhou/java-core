package foroffer.foroffer.time01.top10;
...
public class Test03 {
    ...
    public static void main(String[] args){
        ...
        for (int number : numbers){
            System.out.println(String.format("contains  %d, %b", number, Test03.contains(matrix, number)));
            System.out.println(String.format("contains2 %d, %b", number, Test03.contains2(matrix, number)));
            System.out.println(String.format("contains3 %d, %b", number, Test03.contains3(matrix, number)));
        }
    }
}
